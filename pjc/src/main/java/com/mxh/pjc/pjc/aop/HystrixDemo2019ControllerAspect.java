...
@Configuration
@Aspect
public class HystrixDemo2019ControllerAspect {
    private Map<Method, Semaphore> semaphoreCache = new ConcurrentHashMap<>();

    private ExecutorService executorService = Executors.newFixedThreadPool(2);
    @Around("@annotation(com.mxh.pjc.pjc.annotation.Limited)")
    public Object aroundLimitedMethodInvocation(ProceedingJoinPoint joinPoint) throws Throwable{
        ...
        if(signature instanceof MethodSignature){
            ...
            //4.在方法主动调用之前，调用semaphore.aquire()方法
            try{
                semaphore.acquire();
                //5.被拦截的方法执行
    ...
    @Around("@annotation(com.mxh.pjc.pjc.annotation.Timeout2019)")
    public Object aroundTimeoutMethodInvocation(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (signature instanceof MethodSignature) {
            ...
            Timeout2019 timeout = method.getAnnotation(Timeout2019.class);
