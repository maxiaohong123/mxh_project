package com.mxh.pdc.pjc.loadblance;
...
public class LoadBalancedRequestInterceptor2018 implements ClientHttpRequestInterceptor {

    @Autowired
    private DiscoveryClient discoveryClient;

    private  Map<String,Set<String>> targetUrlsCache = new HashMap<>();
